      ...
      <Box display="flex" alignItems="center" justifyContent="space-between" mb={3}>
        <Box>
          ...
          <Typography variant="body1" color="#666">
            Monitor the health and performance of the backend services and infrastructure.
          </Typography>
        </Box>
      ...
      <Paper sx={{ p: 3, mb: 3, backgroundColor: '#fff' }}>
        ...
        {loading ? (
          ...
          <Alert severity="error">
            <Typography variant="h6" gutterBottom>Health Check Failed</Typography>
              ...
              <List dense>
                <ListItem>
                  ...
                  <ListItemText 
                    ...
                    secondary={healthStatus.response_time ? `${healthStatus.response_time}ms` : 'N/A'} 
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
                  ...
                  <ListItemText 
                    ...
                    secondary={healthStatus.memory_usage ? `${healthStatus.memory_usage}%` : 'N/A'} 
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
                  ...
                  <ListItemText 
                    primary="Disk Usage" 
                    secondary={healthStatus.disk_usage ? `${healthStatus.disk_usage}%` : 'N/A'} 
                  />
                </ListItem>
              </List>
            </Grid>
      ...
      <Paper sx={{ p: 3, mb: 3, backgroundColor: '#fff' }}>
        ...
        <Grid container spacing={2}>
          {services.map((service) => {
            ...
            const isHealthy = serviceStatus?.status === 'healthy' || serviceStatus?.status === 'ok' || serviceStatus === true;
              ...
              <Card variant="outlined">
                <CardContent>
                  <Box display="flex" alignItems="center" gap={1} mb={2}>
                    ...
                    <Typography variant="subtitle1" fontWeight="bold">Response Time</Typography>
                  </Box>
                  ...
                  <LinearProgress 
                    variant="determinate" 
                    value={Math.min((healthStatus.response_time || 0) / 1000 * 100, 100)}
                    color={healthStatus.response_time > 500 ? 'error' : 'primary'}
              ...
              <Card variant="outlined">
                <CardContent>
                  <Box display="flex" alignItems="center" gap={1} mb={2}>
                    ...
                    <Typography variant="subtitle1" fontWeight="bold">Memory Usage</Typography>
                  </Box>
                  ...
                  <LinearProgress 
                    ...
                    color={healthStatus.memory_usage > 80 ? 'error' : 'secondary'}
                    sx={{ height: 8, borderRadius: 4 }}
                  />
                  <Typography variant="caption" color="textSecondary" mt={1} display="block">
                    Target: &lt; 80%
              ...
              <Card variant="outlined">
                <CardContent>
                  <Box display="flex" alignItems="center" gap={1} mb={2}>
                    ...
                    <Typography variant="subtitle1" fontWeight="bold">Disk Usage</Typography>
                  </Box>
          ...
          <Grid item xs={12} md={6}>
            ...
            <List dense>
              <ListItem>
                <ListItemText 
                  primary="Status" 
                  secondary={healthStatus ? getStatusText(healthStatus.status) : 'Unknown'} 
                />
              </ListItem>
              <ListItem>
                <ListItemText 
            ...
            <List dense>
              ...
              <ListItem>
                ...
                <ListItemText 
                  ...
                  secondary={process.env.REACT_APP_API_URL || 'http://localhost:8000'} 
                />
              </ListItem>
            </List>
          </Grid>
